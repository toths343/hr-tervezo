                ...
                <ul class="navbar-nav mb-2 mb-lg-0 px-3">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ route('entity.list', ['type' => 'partner']) }}">Partnerek</a>
                            </li>
                            <li><a class="dropdown-item" href="{{ route('entity.list', ['type' => 'projekt']) }}">Projektek</a>
                            </li>
                        </ul>
                    </li>
                </ul>
...
<div class="d-flex justify-content-between align-items-center px-2 p-xxl-0 mb-3">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0">
            <li class="breadcrumb-item"><a class="text-decoration-none color-primary" href="{{ route('home.index') }}">Nyitólap</a>
            </li>
