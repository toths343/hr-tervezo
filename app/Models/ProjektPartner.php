...
class ProjektPartner extends Model
{
	...
	{
		return $this->belongsTo(Partner::class, ProjektPartner::PRJP_PAR_ID, Partner::PAR_ID);
	}

	public function projekt(): BelongsTo
	{
		return $this->belongsTo(Projekt::class, ProjektPartner::PRJP_PRJ_ID, Projekt::PRJ_ID);
	}
