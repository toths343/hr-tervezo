...
class ElszamolasiAdatok extends Model
{
	...
	protected $fillable = [
		self::ELSZAM_PRJ_ID,
		self::ELSZAM_AZONOSITO,
		self::ELSZAM_STATUS,
		self::ELSZAM_BENYUJT_DATE,
		self::ELSZAM_ZARAS_DATE,
		self::DKF_BENYUJT_EU_TETELES_ELOLEG,
		self::DKF_BENYUJT_HAZAI_TETELES_ELOLEG,
		self::DKF_BENYUJT_EU_ATALANY_ELOLEG,
		self::DKF_BENYUJT_HAZAI_ATALANY_ELOLEG,
		self::DKF_BENYUJT_EU_TETELES_UTOFIN,
		self::DKF_BENYUJT_HAZAI_TETELES_UTOFIN,
		self::DKF_BENYUJT_EU_ATALANY_UTOFIN,
		self::DKF_BENYUJT_HAZAI_ATALANY_UTOFIN,
		self::DKF_ELFOG_EU_TETELES_ELOLEG,
		self::DKF_ELFOG_HAZAI_TETELES_ELOLEG,
		self::DKF_ELFOG_EU_ATALANY_ELOLEG,
		self::DKF_ELFOG_HAZAI_ATALANY_ELOLEG,
		self::DKF_ELFOG_EU_TETELES_UTOFIN,
		self::DKF_ELFOG_HAZAI_TETELES_UTOFIN,
		self::DKF_ELFOG_EU_ATALANY_UTOFIN,
		self::DKF_ELFOG_HAZAI_ATALANY_UTOFIN,
		self::SZALLITO_BENYUJT_EU_TETELES_ELOLEG,
		self::SZALLITO_BENYUJT_HAZAI_TETELES_ELOLEG,
		self::SZALLITO_BENYUJT_EU_ATALANY_ELOLEG,
		self::SZALLITO_BENYUJT_HAZAI_ATALANY_ELOLEG,
		self::SZALLITO_BENYUJT_EU_TETELES_UTOFIN,
		self::SZALLITO_BENYUJT_HAZAI_TETELES_UTOFIN,
		self::SZALLITO_BENYUJT_EU_ATALANY_UTOFIN,
		self::SZALLITO_BENYUJT_HAZAI_ATALANY_UTOFIN,
		self::SZALLITO_ELFOG_EU_TETELES_ELOLEG,
		self::SZALLITO_ELFOG_HAZAI_TETELES_ELOLEG,
		self::SZALLITO_ELFOG_EU_ATALANY_ELOLEG,
		self::SZALLITO_ELFOG_HAZAI_ATALANY_ELOLEG,
		self::SZALLITO_ELFOG_EU_TETELES_UTOFIN,
		self::SZALLITO_ELFOG_HAZAI_TETELES_UTOFIN,
		self::SZALLITO_ELFOG_EU_ATALANY_UTOFIN,
		self::SZALLITO_ELFOG_HAZAI_ATALANY_UTOFIN,
		self::DKF_BENYUJT_TETELES_ELOLEG_MEGJ,
		self::DKF_BENYUJT_ATALANY_ELOLEG_MEGJ,
		self::DKF_BENYUJT_TETELES_UTOFIN_MEGJ,
		self::DKF_BENYUJT_ATLANY_UTOFIN_MEGJ,
		self::DKF_ELFOG_TETELES_ELOLEG_MEGJ,
		self::DKF_ELFOG_ATALANY_ELOLEG_MEGJ,
		self::DKF_ELFOG_TETELES_UTOFIN_MEGJ,
		self::DKF_ELFOG_ATLANY_UTOFIN_MEGJ,
		self::SZALLITO_BENYUJT_TETELES_ELOLEG_MEGJ,
		self::SZALLITO_BENYUJT_ATALANY_ELOLEG_MEGJ,
		self::SZALLITO_BENYUJT_TETELES_UTOFIN_MEGJ,
		self::SZALLITO_BENYUJT_ATLANY_UTOFIN_MEGJ,
		self::SZALLITO_ELFOG_TETELES_ELOLEG_MEGJ,
		self::SZALLITO_ELFOG_ATALANY_ELOLEG_MEGJ,
		self::SZALLITO_ELFOG_TETELES_UTOFIN_MEGJ,
		self::SZALLITO_ELFOG_ATLANY_UTOFIN_MEGJ,
		self::ELSZAM_CREATED,
		self::ELSZAM_CREATER,
		self::ELSZAM_LASTUPD,
		self::ELSZAM_MODIFIER,
		self::ELSZAM_DEL
	];

	public function projekt(): BelongsTo
	{
		return $this->belongsTo(Projekt::class, ElszamolasiAdatok::ELSZAM_PRJ_ID, Projekt::PRJ_ID);
	}
}
